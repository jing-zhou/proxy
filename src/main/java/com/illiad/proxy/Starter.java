...
public class Starter {
    ...
    public Starter(Params params, Ssl ssl, Utils utils, HandlerNamer namer, V5ServerEncoder v5ServerEncoder, V5ClientEncoder v5ClientEncoder, V5AddressDecoder v5AddressDecoder) {
            ...
            b.group(bossGroup, workerGroup).channel(NioServerSocketChannel.class)
                ...
                protected void initChannel(NioSocketChannel ch) {
                    ...
                    pipeline.addLast(new LoggingHandler(LogLevel.INFO),
                            new VersionHandler(ssl, params, namer, v5ClientEncoder, v5ServerEncoder, v5AddressDecoder, utils));
                }
            });
